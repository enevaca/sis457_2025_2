...
using WebMinerva2.Models;

namespace WebMinerva2.Controllers
{
    public class ProductosController : Controller
    {
        private readonly Minerva2Context _context;

        public ProductosController(Minerva2Context context)
        {
            _context = context;
        }
        ...
        {
            var minerva2Context = _context.Producto.Include(p => p.IdUnidadMedidaNavigation);
            return View(await minerva2Context.ToListAsync());
        }
