...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Compra__3213E83F807036E6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CompraDe__3213E83FB2A1A049");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Empleado__3213E83F58E10F3A");

            entity.HasIndex(e => e.CedulaIdentidad, "UQ__Empleado__9FE1EA244E29B67F").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Producto__3213E83F01EDED04");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Proveedo__3213E83F8D13773B");

            entity.HasIndex(e => e.RazonSocial, "UQ__Proveedo__17BADCA034A4040B").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UnidadMe__3213E83F5F80556B");

            entity.HasIndex(e => e.Descripcion, "UQ__UnidadMe__298336B671173380").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Usuario__3213E83F5A5A2D64");

            entity.HasIndex(e => e.Usuario1, "UQ__Usuario__9AFF8FC69535C995").IsUnique();
